...
const TEST_FILES = Object.freeze([
  ...
  ".product-test-dist/src/lib/protection/receivable-conflict-session.test.js",
  ".product-test-dist/src/lib/protection/receivable-conflict-session-store.test.js",
  ".product-test-dist/src/lib/protection/receivable-conflict-session-runner.test.js",
