  ...
  return (
    <PublicShell surface="landing">
      <section className={styles.panel} aria-labelledby="not-found-title">
        ...
        <p className={styles.lede}>The live check, the verified evidence and the pilot path are all still here.</p>
        <div className={styles.actions}>
          <Link className={styles.primary} href="/protection/live">Run the live check</Link>
