/**
 * Supported, qualified participant-originated authorization chain.
 *
 ...
 * this protocol is only for the native-CLI participant-originated profile.
 *
 ...
 * commitment preimage. The qualified profile relies on a pinned, honest participant
...
/** Pure, network-free EOA verification. ERC-1271 is intentionally out of scope for this qualified EOA-only profile. */
