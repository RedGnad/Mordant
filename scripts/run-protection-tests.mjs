...
const TEST_FILES = Object.freeze([
  ...
  ".product-test-dist/src/lib/protection/participant-originated-authorization.test.js",
  ...
  ".product-test-dist/src/lib/protection/verified-live-run.test.js",
  ...
  ".product-test-dist/src/lib/protection/settlement-profile-store.test.js",
  ".product-test-dist/src/lib/protection/direct-participant-evidence-assembly.test.js",
  ".product-test-dist/src/lib/protection/reviewed-adapter-artifacts.test.js",
  ...
  "scripts/participant-originated-coordinator.test.mjs",
  "scripts/run-participant-originated-qualification.test.mjs",
